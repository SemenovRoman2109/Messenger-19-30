...
const observer = new IntersectionObserver(async (entries)=>{
    if (entries[0].isIntersecting){
        ...
        if (data.success){
            ...
            observer.disconnect()
            // observer.disconnect() - функція, що зупиняє відстежування елемнетів
            // елемент.insertAdjacentHTML('beforebegin', "html_розмітка") - вставляє html розмітку перед елементом
        }
    }
}, {
    rootMargin: "200px"
...
//  - створює об'єкт, що буде виконувати код кожен раз коли вкзааний елемент видно на екрані
